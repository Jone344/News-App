...
//        cell.configureCell(newsTitle: titles, newsSource: sources)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
      ...
      //  let urls = newsStoryUrlArray[(indexPath?.row)!]
        ...
        self.save(link: newsStoryUrlArray[indexPath.row], image: self.imageURLArray[indexPath.row], title: self.titleArray[indexPath.row], source: self.newsSourceArray[indexPath.row])
    }
}
